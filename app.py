...
with tab1:
    ...
    with right:
        ...
        st.caption(t("يتكوّن المؤشر من: فرص السوق 45%، توافق الخبرة 30%، سياق المدينة 15%، وتوافق الراتب المتوقع 10%.",
                     "Score weights: market opportunity 45%, experience alignment 30%, city context 15%, salary expectation alignment 10%."))
        c,d=st.columns(2)
